...
El sistema a desarrollar está planteado en el contexto del negocio bancario que extiende las funcionalidades y requerimientos presentados en el proyecto I. Por lo tanto, en este enunciado solo se agregan nuevas características o modificaciones a las ya presentada en el proyecto anterior.
...
· Implementar circuit breaker en los microservicios usando Resilence4j y configurar un timeout de 2 segundos.
...
o Cuenta de ahorro que requiere un monto mínimo de promedio diario cada mes. Adicionalmente, para solicitar este producto el cliente debe tener una tarjeta de crédito con el banco al momento de la creación de la cuenta. 

Empresarial: 

§ PYME

o Cuenta corriente sin comisión de mantenimiento. Como requisito, el cliente debe tener una tarjeta de crédito con el banco al momento de la creación de la cuenta. 
...
o Generar un reporte completo y general por producto del banco en intervalo de tiempo especificado por el usuario.

o Implementar un reporte con los últimos 10 movimientos de la tarjeta de débito y de crédito.


Parte III - Proyecto Final

El sistema a desarrollar está planteado en el contexto del negocio bancario que extiende las funcionalidades y requerimientos presentados en el proyecto II. Por lo tanto, en este enunciado solo se agregan nuevas características o modificaciones a las ya presentada en el proyecto anterior.
...
· Los controladores que implementen las nuevas funcionalidades deberán ser reactivas usando para ella el modelo de Reactividad usando RX java y el framework Spring. 
...
· Los clientes ahora pueden tener tarjetas de débito asociado a sus cuentas bancarias y hacer pagos con ellas.

· El banco desea implementar un monedero móvil llamado Yanki con las siguientes características:

o No se necesitar ser un cliente del banco para tener un monedero movil, solo se necesita un número de documento de identificación (DNI, CEX, Pasaporte), número de celular, el IMEI del celular y correo electrónico.

o El usuario puede recibir y enviar pagos a su monedero con solo su número de celular.

o Puede asociar su monedero a una tarjeta de débito del banco de manera que el saldo sea cargado o acreditado solo a la cuenta principal asociada a la tarjeta de débito.
